...
//       method: "POST",
//       headers: {
//         Authorization: `Bearer ${process.env.VITE_DS_TOKEN}`,
      ...
      "https://api.deepseek.com/v1/chat/completions",
      {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: `You are an assistant that receives a list of ingredients and suggests a recipe. Format in markdown.`,
            },
            {
              role: "user",
